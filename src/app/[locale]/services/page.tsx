...
export default async function Index( { params } : { params:{locale:string } } ) {
    ...
    const breadcrumbItems = [
      ...
      { name: messages.navigation.services, url: canonicalUrl }
    ];
            ...
            <div className="container">
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4 p-4'>
                    <div className='p-4 mb-5'>
                        <img className="w-50" alt="working people" title="working people at pixium" src="/assets/images/working-people.webp" />
                    </div>
